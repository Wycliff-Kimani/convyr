    ...
    <main>
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-8 h-[64px] border-b border-gray-100 bg-white">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm text-gray-500">
          <Link href="/pricing" className="hover:text-[#075E54] transition-colors">Pricing</Link>
          <Link href="/about" className="hover:text-[#075E54] transition-colors">About</Link>
          <Link href="/contact" className="hover:text-[#075E54] transition-colors">Contact</Link>
        </div>
        <div className="flex items-center gap-4">
          <Link href="/login" className="text-sm text-gray-500 hover:text-[#075E54] transition-colors">
            Log in
          </Link>
          <Link
            href="/register"
      ...
      <section className="bg-white py-20 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base text-gray-400 max-w-xl mx-auto leading-relaxed">
            Convyr was born from a simple observation — 90% of Kenyan businesses run their customer service on WhatsApp, manually, one message at a time. We built the tool we wished existed.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-500 leading-relaxed mb-4">
              To give every small business in Africa the same automation tools that large corporations use — without the complexity, without the cost, and without needing a tech team.
            </p>
            <p className="text-gray-500 leading-relaxed">
              We believe a mama mboga, a salon owner, or a school admin should be able to automate their WhatsApp in 5 minutes and get back to doing what they do best.
            </p>
          </div>
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-[#0F172A] mb-12">The Founder</h2>
          <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
            ...
            <p className="text-sm text-[#25D366] font-medium mt-1">Founder & CEO — DevCraft Technologies</p>
            <p className="text-gray-500 text-sm mt-4 leading-relaxed max-w-lg mx-auto">
              Software developer based in Kenya. Building tools that solve real African business problems. Convyr is the product I needed before I built it.
            </p>
      ...
      <section className="bg-[#0F172A] py-20 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to automate your WhatsApp?</h2>
          <p className="text-gray-400 mb-8">Set up in 5 minutes. No tech skills needed.</p>
          <Link
            href="/register"
